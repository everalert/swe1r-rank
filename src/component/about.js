...
export default () => (
	<main className="about">
		...
		<p>Times are gathered using the Speedrun.com API. To join the rankings, submit your times to the Star Wars Racer <a href="https://www.speedrun.com/swe1r/individual_levels" alt="SWE1R Level Leaderboard" target="_blank">Level Leaderboard</a> on Speedrun.com, and they will automatically appear on RacerRank once verified.</p>

		<p>To get involved with the community and discuss time trial strategy, join the Star Wars Racer <a href="https://discord.gg/ctmKzzF" alt="Star Wars Racer on Discord" target="_blank">Discord Server</a>. Beginners are more than welcome!</p>

		<p>RacerRank source code can be found on <a href="https://github.com/everalert/swe1r-rank" alt="RacerRank source code repository" target="_blank">Github</a>.</p>
	</main>
);